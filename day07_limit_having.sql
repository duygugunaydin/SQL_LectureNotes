...
-- Group By'da bir fielda gore gruplama yapip, 
-- Aggregate Function'lar yardimiyla baska bir field'da islem yapip bize islem yaptigi field'i 
-- bize islem yaptigi field'i yeni bir field olarak donduruyor.
...
-- 5) CHICKENLARI(Manavdan kac cesit meyve satildigini numerik) listeleyen bir query yaziniz :)
